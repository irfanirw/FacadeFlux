...
namespace BcaEttv
{
    public class DeconstructEttvSurfaceComponent : GH_Component
    {
        ...
        {
            pManager.AddGenericParameter("EttvSurfaces", "S", "List of BcaEttvCore.EttvSurface", GH_ParamAccess.list);
            pManager[0].Optional = true;
        }

        protected override void RegisterOutputParams(GH_OutputParamManager pManager)
        {
            pManager.AddTextParameter("Text", "T", "Per-surface summary text (one item per EttvSurface)", GH_ParamAccess.list); // 0
            ...
            pManager.AddTextParameter("Orientations", "O", "List of EttvOrientation.Name", GH_ParamAccess.list); // 3
            pManager.AddGenericParameter("EttvConstructions", "C", "List of EttvConstruction", GH_ParamAccess.list); // 4
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (rawItems.Count == 0)
            {
                ...
                DA.SetDataList(4, new List<EttvConstruction>());
                return;
            }
            ...
            var constructions = new List<EttvConstruction>();
            ...
            foreach (var s in surfaces)
            {
                ...
                texts.Add(EttvSurfaceDeconstructor.ToText(s).TrimEnd());
                ...
                // Orientation
                orientationNames.Add((s.Orientation ?? new EttvOrientation()).Name ?? string.Empty);
